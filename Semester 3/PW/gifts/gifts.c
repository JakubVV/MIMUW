...
int reindeer_main(int id, struct SharedStorage* s)
{
    ...
    bool last = (--s->n_gifts_to_deliver == 0);
...
// gcc -c err.c && gcc -c gifts.c && gcc err.o gifts.o -o gifts && ./gifts